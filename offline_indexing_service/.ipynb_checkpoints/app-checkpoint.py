...
# def batch_cosine_similarity(query_vec, doc_matrix, batch_size=10000):
#     """احسب cosine similarity على دفعات لتوفير الذاكرة"""
#     num_docs = doc_matrix.shape[0]
#     all_scores = []
#     for start in range(0, num_docs, batch_size):
#         end = min(start + batch_size, num_docs)
#         batch = doc_matrix[start:end]
#         scores = cosine_similarity(query_vec, batch)[0]
